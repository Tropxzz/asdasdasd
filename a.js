...
"Will you let compassion manage your wishes?",
...
"You enjoy giving... You will have a happier day.",
...
app.post('/api/data', (req, res) => {
    ...
    newData.id = Math.floor(Math.random() * 1000); // Assign a random ID
